...
"function"===typeof e?e(a):"function"===typeof b&&b()};this.createPeriodicWave=this.createWaveTable=function(a,e){return new waapisimPeriodicWave(a,e)};this._SortNode=function(){var a,e,b,c;for(a=0;a<this._Nodes.length;++a)if(c=this._Nodes[a],0<c._order)for(e=0;e<c._nodein.length;++e)for(b=0;b<c._nodein[e].from.length;++b){var g=c._nodein[e].from[b].node._order;c._order<g+1&&(c._order=g+1)}this._Nodes.sort(function(c,b){return b._order-c._order})};this._RegisterNode=function(a){for(var e=this._Nodes.length;e--;)if(this._Nodes[e]===
